...
* [YMIR](https://deepai.org/publication/ymir-a-rapid-data-centric-development-platform-for-vision-applications) - A Rapid Data-centric Development Platform for Vision Applications.
* [DevOps in Academic Research](https://mattsegal.dev/devops-academic-research.html) - Compherensive research about DevOps including MLOps.
* [Versioning Data Is About More than Revisions](https://datascience.codata.org/articles/10.5334/dsj-2021-012/) - A Conceptual Framework and Proposed Principles.
* [Asset Management in Machine Learning](https://arxiv.org/pdf/2102.06919.pdf) - A survey about practical MLOps techniques and tools.
